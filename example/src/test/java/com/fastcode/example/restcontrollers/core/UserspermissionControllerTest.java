...
public class UserspermissionControllerTest extends DatabaseContainerConfig {
    ...
    public Userspermission createEntity() {
        ...
        userspermissionEntity.setUsersUsername("1");
        ...
        userspermissionEntity.setUsersUsername(users.getUsername());
    ...
    public CreateUserspermissionInput createUserspermissionInput() {
        ...
        userspermissionInput.setUsersUsername("5");
    ...
    public Userspermission createNewEntity() {
        ...
        userspermission.setUsersUsername("3");
    ...
    public Userspermission createUpdateEntity() {
        ...
        userspermission.setRevoked(false);
        userspermission.setUsersUsername("4");
        ...
        mvc
            .perform(
                get(
                    ...
                    ",usersUsername=" +
                    userspermission.getUsersUsername() +
                    "/"
                )
        ...
        org.assertj.core.api.Assertions
            .assertThatThrownBy(
                () ->
                    mvc
                        .perform(
                            get("/userspermission/permissionId=999,usersUsername=999")
                                .contentType(MediaType.APPLICATION_JSON)
                        )
                        .andExpect(status().isOk())
            )
    ...
    public void CreateUserspermission_UserspermissionDoesNotExist_ReturnStatusOk() throws Exception {
        ...
        userspermissionInput.setUsersUsername(users.getUsername());
        ...
        org.assertj.core.api.Assertions
            .assertThatThrownBy(
                () ->
                    mvc
                        .perform(
                            delete("/userspermission/permissionId=999,usersUsername=999")
                                .contentType(MediaType.APPLICATION_JSON)
                        )
                        .andExpect(status().isOk())
            )
            .hasCause(
                new EntityNotFoundException(
                    "There does not exist a userspermission with a id=permissionId=999,usersUsername=999"
                )
            );
    }
    ...
    public void Delete_IdIsValid_ReturnStatusNoContent() throws Exception {
        ...
        //    Mockito.when(userspermissionAppService.findById(new UserspermissionId(entity.getPermissionId(), entity.getUsersUsername()))).thenReturn(output);
        Mockito
            .doReturn(output)
            .when(userspermissionAppService)
            .findById(new UserspermissionId(entity.getPermissionId(), entity.getUsersUsername()));
    ...
    public void UpdateUserspermission_UserspermissionDoesNotExist_ReturnStatusNotFound() throws Exception {
        ...
        userspermission.setRevoked(false);
        userspermission.setUsersUsername("999");
        ...
        org.assertj.core.api.Assertions
            .assertThatThrownBy(
                () ->
                    mvc
                        .perform(
                            put("/userspermission/permissionId=999,usersUsername=999")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(json)
                        )
                        .andExpect(status().isOk())
            ...
            .hasCause(
                new EntityNotFoundException(
                    "Unable to update. Userspermission with id=permissionId=999,usersUsername=999 not found."
                )
            );
    }
    ...
    public void UpdateUserspermission_UserspermissionExists_ReturnStatusOk() throws Exception {
        ...
        Mockito
            .when(
                userspermissionAppService.findById(
                    new UserspermissionId(entity.getPermissionId(), entity.getUsersUsername())
                )
            )
            .thenReturn(output);
        ...
        userspermissionInput.setUsersUsername(entity.getUsersUsername());
        ...
        org.assertj.core.api.Assertions
            .assertThatThrownBy(
                () ->
                    mvc
                        .perform(
                            get("/userspermission/permissionId=999,usersUsername=999/permission")
                                .contentType(MediaType.APPLICATION_JSON)
                        )
                        .andExpect(status().isOk())
            )
        ...
        org.assertj.core.api.Assertions
            .assertThatThrownBy(
                () ->
                    mvc
                        .perform(
                            get("/userspermission/permissionId=999,usersUsername=999/users")
                                .contentType(MediaType.APPLICATION_JSON)
                        )
                        .andExpect(status().isOk())
            )
