...
public class TokenVerificationManager implements ITokenVerificationManager {
    ...
    public Tokenverification findByUsersIdAndType(String username, String tokenType) {
        return _tokenRepository.findByUsersUsernameAndTokenType(username, tokenType);
    }
