...
public class ReportversionAppService implements IReportversionAppService {
    ...
    public CreateReportversionOutput create(CreateReportversionInput input) {
        ...
        if (input.getUserUsername() != null) {
            Users foundUsers = _usersRepository.findById(input.getUserUsername()).orElse(null);
    ...
    public void delete(ReportversionId reportversionId) {
        ...
        Users users = _usersRepository.findById(reportversionId.getUserUsername()).get();
    ...
    @Transactional(propagation = Propagation.NOT_SUPPORTED)
    public List<FindReportversionByIdOutput> findByUsersId(String userUsername) {
        List<Reportversion> reportList = _reportversionRepository.findByUsersId(userUsername);
    ...
    protected BooleanBuilder searchKeyValuePair(
        ...
        for (Map.Entry<String, String> joinCol : joinColumns.entrySet()) {
            if (joinCol != null && joinCol.getKey().equals("userUsername")) {
                builder.and(reportversion.users.username.eq(joinCol.getValue()));
            }
        }
        return builder;
    }
