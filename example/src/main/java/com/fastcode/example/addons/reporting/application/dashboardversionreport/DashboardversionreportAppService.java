...
public class DashboardversionreportAppService implements IDashboardversionreportAppService {
    ...
    public CreateDashboardversionreportOutput create(CreateDashboardversionreportInput input) {
        ...
        if (input.getDashboardId() != null) {
            Dashboardversion foundDashboard = _dashboardversionRepository
                .findById(
                    new DashboardversionId(input.getUserUsername(), input.getDashboardId(), input.getDashboardVersion())
                )
                .orElse(null);
    ...
    public Boolean addReportsToDashboardRunningversion(
        ...
        Dashboardversion dashboardrunningVersion = _dashboardversionRepository
            .findById(new DashboardversionId(dashboard.getOwnerUsername(), dashboard.getId(), "running"))
            .orElse(null);
        if (dashboardrunningVersion != null) {
            ...
            reportdashboard.setUserUsername(dashboardrunningVersion.getUserUsername());
        }
    ...
    public Boolean addReportsToDashboardPublishedversion(
        ...
        Dashboardversion dashboardPublishedVersion = _dashboardversionRepository
            .findById(new DashboardversionId(dashboard.getOwnerUsername(), dashboard.getId(), "published"))
            .orElse(null);
        if (dashboardPublishedVersion != null) {
            ...
            reportdashboard.setUserUsername(dashboardPublishedVersion.getUserUsername());
        }
        ...
        Dashboardversion dashboardversion = _dashboardversionRepository
            .findById(
                new DashboardversionId(
                    reportdashboardId.getUserUsername(),
        ...
        for (int i = 0; i < list.size(); i++) {
            if (
                !(
                    ...
                    list.get(i).replace("%20", "").trim().equals("userUsername") ||
    ...
    protected BooleanBuilder searchKeyValuePair(
        ...
        for (Map.Entry<String, String> joinCol : joinColumns.entrySet()) {
            ...
            if (joinCol != null && joinCol.getKey().equals("userUsername")) {
                builder.and(reportdashboard.dashboardversionEntity.userUsername.eq(joinCol.getValue()));
            }
    ...
    public DashboardversionreportId parseReportdashboardKey(String keysString) {
        ...
        reportdashboardId.setDashboardId(Long.valueOf(keyMap.get("userusername")));
