...
public class RegistrationController {
    ...
    public ResponseEntity<HashMap<String, String>> registerUserAccount(
        ...
        sendVerificationEmail(clientUrl, output.getEmail(), output.getUsername());
    ...
    public ResponseEntity<HashMap<String, String>> verifyEmail(@RequestParam("token") final String token) {
        ...
        FindUsersWithAllFieldsByIdOutput output = _usersAppService.findWithAllFieldsById(
            tokenEntity.getUsersUsername()
        );
        Optional
            .ofNullable(output)
            .orElseThrow(() -> new EntityNotFoundException(String.format("Invalid verification link.")));
        ...
        if (new Date().after(tokenEntity.getExpirationTime())) {
            ...
            _usersAppService.delete(tokenEntity.getUsersUsername());
    ...
    public ResponseEntity<HashMap<String, String>> resendVerificationEmail(
        ...
        sendVerificationEmail(clientUrl, foundUsers.getEmail(), foundUsers.getUsername());
    ...
    private void sendVerificationEmail(String clientUrl, String emailAddress, String usersId) {
