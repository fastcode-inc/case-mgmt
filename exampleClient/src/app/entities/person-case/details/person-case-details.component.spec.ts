...
import { IPersonCase, PersonCaseService, PersonCaseDetailsComponent, PersonCaseListComponent } from '../';
...
describe('PersonCaseDetailsComponent', () => {
  let component: PersonCaseDetailsComponent;
  let fixture: ComponentFixture<PersonCaseDetailsComponent>;
  let el: HTMLElement;
  ...
  describe('Unit Tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [PersonCaseDetailsComponent, DetailsComponent],
        imports: [TestingModule],
        providers: [PersonCaseService],
        schemas: [NO_ERRORS_SCHEMA],
      }).compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(PersonCaseDetailsComponent);
  ...
  describe('Integration Tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'personcase', component: PersonCaseDetailsComponent },
            { path: 'personcase/:id', component: PersonCaseListComponent },
          ]),
        ],
        providers: [PersonCaseService],
      }).compileComponents();
    ...
    it('should go back to list component when back button is clicked', async () => {
      ...
      expect(location.path()).toBe('/personcase');
    });
  });
});
