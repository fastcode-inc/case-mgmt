...
import { IPersonCase, PersonCaseService, PersonCaseNewComponent } from '../';
import { DateUtils } from 'src/app/common/shared';
import { NewComponent, FieldsComp } from 'src/app/common/general-components';

describe('PersonCaseNewComponent', () => {
  let component: PersonCaseNewComponent;
  let fixture: ComponentFixture<PersonCaseNewComponent>;
  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [PersonCaseNewComponent, NewComponent, FieldsComp],
        imports: [TestingModule],
        providers: [PersonCaseService, { provide: MAT_DIALOG_DATA, useValue: {} }],
        schemas: [NO_ERRORS_SCHEMA],
      }).compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(PersonCaseNewComponent);
  ...
  describe('Integration tests', () => {
    ...
    describe('', () => {
      it('should set the passed data to form', async () => {
        TestBed.configureTestingModule({
          declarations: [PersonCaseNewComponent, NewComponent, FieldsComp].concat(EntryComponents),
          imports: [TestingModule],
          providers: [PersonCaseService, { provide: MAT_DIALOG_DATA, useValue: relationData }],
        });
