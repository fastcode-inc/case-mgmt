...
import { ICaseHistory, CaseHistoryService, CaseHistoryDetailsComponent, CaseHistoryListComponent } from '../';
...
describe('CaseHistoryDetailsComponent', () => {
  ...
  describe('Unit Tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [CaseHistoryDetailsComponent, DetailsComponent],
  ...
  describe('Integration Tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'casehistory', component: CaseHistoryDetailsComponent },
            { path: 'casehistory/:id', component: CaseHistoryListComponent },
          ]),
        ],
        providers: [CaseHistoryService],
      }).compileComponents();
    ...
    it('should go back to list component when back button is clicked', async () => {
      ...
      expect(location.path()).toBe('/casehistory');
    });
  });
});
