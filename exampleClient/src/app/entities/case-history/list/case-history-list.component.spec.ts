...
import {
  ...
  CaseHistoryNewComponent,
} from '../';

describe('CaseHistoryListComponent', () => {
  let fixture: ComponentFixture<CaseHistoryListComponent>;
  let component: CaseHistoryListComponent;
  let el: HTMLElement;

  let d = new Date();
  let t = DateUtils.formatDateStringToAMPM(d);
  let constData: ICaseHistory[] = [
    {
      caseHistoryId: 1,
      message: 'message1',
  ...
  let data: ICaseHistory[] = [...constData];

  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [CaseHistoryListComponent, ListComponent],
        imports: [TestingModule],
        providers: [CaseHistoryService, ChangeDetectorRef],
        schemas: [NO_ERRORS_SCHEMA],
      }).compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(CaseHistoryListComponent);
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'casehistory', component: CaseHistoryListComponent },
            { path: 'casehistory/:id', component: CaseHistoryDetailsComponent },
          ]),
        ],
        providers: [CaseHistoryService, ChangeDetectorRef],
      }).compileComponents();
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(
        `/casehistory/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`
      );
    });
