...
import { ICaseHistory, CaseHistoryService, CaseHistoryNewComponent } from '../';
import { DateUtils } from 'src/app/common/shared';
import { NewComponent, FieldsComp } from 'src/app/common/general-components';

describe('CaseHistoryNewComponent', () => {
  let component: CaseHistoryNewComponent;
  let fixture: ComponentFixture<CaseHistoryNewComponent>;
  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [CaseHistoryNewComponent, NewComponent, FieldsComp],
        imports: [TestingModule],
        providers: [CaseHistoryService, { provide: MAT_DIALOG_DATA, useValue: {} }],
        schemas: [NO_ERRORS_SCHEMA],
      }).compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(CaseHistoryNewComponent);
  ...
  describe('Integration tests', () => {
    ...
    describe('', () => {
      it('should set the passed data to form', async () => {
        TestBed.configureTestingModule({
          declarations: [CaseHistoryNewComponent, NewComponent, FieldsComp].concat(EntryComponents),
          imports: [TestingModule],
          providers: [CaseHistoryService, { provide: MAT_DIALOG_DATA, useValue: relationData }],
        });
