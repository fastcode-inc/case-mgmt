...
import { ICases, CasesService, CasesDetailsComponent, CasesListComponent } from '../';
...
describe('CasesDetailsComponent', () => {
  ...
  describe('Unit Tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [CasesDetailsComponent, DetailsComponent],
  ...
  describe('Integration Tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [CasesDetailsComponent, CasesListComponent, DetailsComponent, ListComponent, FieldsComp].concat(
          EntryComponents
        ),
        imports: [
          TestingModule,
          RouterTestingModule.withRoutes([
            { path: 'cases', component: CasesDetailsComponent },
            { path: 'cases/:id', component: CasesListComponent },
          ]),
        ],
        providers: [CasesService],
      }).compileComponents();
