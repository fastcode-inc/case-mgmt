...
import { ICases, CasesService, CasesNewComponent } from '../';
  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [CasesNewComponent, NewComponent, FieldsComp],
        imports: [TestingModule],
        providers: [CasesService, { provide: MAT_DIALOG_DATA, useValue: {} }],
  ...
  describe('Integration tests', () => {
    ...
    describe('', () => {
      it('should set the passed data to form', async () => {
        TestBed.configureTestingModule({
          declarations: [CasesNewComponent, NewComponent, FieldsComp].concat(EntryComponents),
          imports: [TestingModule],
          providers: [CasesService, { provide: MAT_DIALOG_DATA, useValue: relationData }],
        });
