...
import { ICases, CasesService, CasesDetailsComponent, CasesListComponent, CasesNewComponent } from '../';
...
describe('CasesListComponent', () => {
  ...
  let data: ICases[] = [...constData];

  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [CasesListComponent, ListComponent],
        imports: [TestingModule],
        providers: [CasesService, ChangeDetectorRef],
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(
        `/cases/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`
      );
    });
