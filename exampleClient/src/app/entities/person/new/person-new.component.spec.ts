...
import { IPerson, PersonService, PersonNewComponent } from '../';
  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [PersonNewComponent, NewComponent, FieldsComp],
        imports: [TestingModule],
        providers: [PersonService, { provide: MAT_DIALOG_DATA, useValue: {} }],
  ...
  describe('Integration tests', () => {
    ...
    describe('', () => {
      it('should set the passed data to form', async () => {
        TestBed.configureTestingModule({
          declarations: [PersonNewComponent, NewComponent, FieldsComp].concat(EntryComponents),
          imports: [TestingModule],
          providers: [PersonService, { provide: MAT_DIALOG_DATA, useValue: relationData }],
        });
