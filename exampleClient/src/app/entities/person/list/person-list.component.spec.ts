...
import { IPerson, PersonService, PersonDetailsComponent, PersonListComponent, PersonNewComponent } from '../';
...
describe('PersonListComponent', () => {
  ...
  let data: IPerson[] = [...constData];

  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [PersonListComponent, ListComponent],
        imports: [TestingModule],
        providers: [PersonService, ChangeDetectorRef],
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(
        `/person/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`
      );
    });
