...
import { ICaseDocument, CaseDocumentService, CaseDocumentNewComponent } from '../';
import { DateUtils } from 'src/app/common/shared';
import { NewComponent, FieldsComp } from 'src/app/common/general-components';

describe('CaseDocumentNewComponent', () => {
  let component: CaseDocumentNewComponent;
  let fixture: ComponentFixture<CaseDocumentNewComponent>;
  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [CaseDocumentNewComponent, NewComponent, FieldsComp],
        imports: [TestingModule],
        providers: [CaseDocumentService, { provide: MAT_DIALOG_DATA, useValue: {} }],
        schemas: [NO_ERRORS_SCHEMA],
      }).compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(CaseDocumentNewComponent);
  ...
  describe('Integration tests', () => {
    ...
    describe('', () => {
      it('should set the passed data to form', async () => {
        TestBed.configureTestingModule({
          declarations: [CaseDocumentNewComponent, NewComponent, FieldsComp].concat(EntryComponents),
          imports: [TestingModule],
          providers: [CaseDocumentService, { provide: MAT_DIALOG_DATA, useValue: relationData }],
        });
