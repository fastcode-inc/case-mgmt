...
import { ICaseDocument, CaseDocumentService, CaseDocumentDetailsComponent, CaseDocumentListComponent } from '../';
...
describe('CaseDocumentDetailsComponent', () => {
  let component: CaseDocumentDetailsComponent;
  let fixture: ComponentFixture<CaseDocumentDetailsComponent>;
  let el: HTMLElement;
  ...
  describe('Unit Tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [CaseDocumentDetailsComponent, DetailsComponent],
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(CaseDocumentDetailsComponent);
  ...
  describe('Integration Tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'casedocument', component: CaseDocumentDetailsComponent },
            { path: 'casedocument/:id', component: CaseDocumentListComponent },
          ]),
        ],
        providers: [CaseDocumentService],
      }).compileComponents();
    ...
    it('should go back to list component when back button is clicked', async () => {
      ...
      expect(location.path()).toBe('/casedocument');
    });
  });
});
