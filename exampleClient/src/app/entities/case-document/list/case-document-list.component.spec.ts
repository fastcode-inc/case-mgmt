...
describe('CaseDocumentListComponent', () => {
  ...
  let data: ICaseDocument[] = [...constData];

  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [CaseDocumentListComponent, ListComponent],
        imports: [TestingModule],
        providers: [CaseDocumentService, ChangeDetectorRef],
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'casedocument', component: CaseDocumentListComponent },
            { path: 'casedocument/:id', component: CaseDocumentDetailsComponent },
          ]),
        ],
        providers: [CaseDocumentService, ChangeDetectorRef],
      }).compileComponents();
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(
        `/casedocument/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`
      );
    });
